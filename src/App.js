    ...
    <>
      <div className="content-wrapper">
        ...
        <div className="button-container">
          <button title="Randomise list" type="button" className="random-button" data-testid="randomButton" onClick={(event) => handleRandomise(event)}>
          ...
          <button title="Clear list" type="button" className="clear-button" data-testid="clearButton" onClick={(event) => handleClear(event)}>
          ...
          <button title="Copy list to clipboard" type="button" className="copy-button" data-testid="copyButton" onClick={(event) => handleCopy(event)}>
            ...
            .map((item, index) => {
              return (
                <li key={`${item}-${index}`} data-testid={`name-${index}`} index={index}>
                  ...
                  <button title="Remove from list" onClick={(event) => handleListItemDelete(event)} className="item-remove-button">-</button>
                </li>
              )
            })}
        </ol>
