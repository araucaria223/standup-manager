    ...
    <>
      <div className="content-wrapper">
        ...
        <div className="button-container">
          ...
          <button type="button" className="copy-button" data-testid="copyButton" onClick={(event) => handleCopy(event)}>
            ...
            .map((item, index) => {
              return (
                <li key={`${item}-${index}`} data-testid={`name-${index}`} index={index}>
                  ...
                  <button onClick={(event) => handleListItemDelete(event)} className="item-remove-button">-</button>
                </li>
              )
            })}
        </ol>
